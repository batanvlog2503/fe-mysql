...
const DepositMoney = () => {
  ...
  return (
    <div className="container deposit-money">
      <div className="inner-wrap-deposit">
        <div className="form-deposit">
          <div className="title-deposit text-center">
            <h3
              style={{
                fontSize: "40px",
                color: "Black",
          ...
          >
            ...
            <div className="input-group mb-3">
              ...
              <button
                ...
                disabled={!customer.username || isLoading}
              >
                {isLoading ? (
            ...
            {/* Submit button */}
            <div className="button-submit deposit mt-4">
              <button
                type="submit"
